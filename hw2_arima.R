...
### TO DO
output<-data.frame()
temp = list.files(path="/gpfs/courses/cse587/spring2015/data/hw2/data/", pattern=".csv",full.names=TRUE)
...
dev.off()
save(output,file="data-arima.Rda")
write.csv(output[1:10,2],'Arima.csv')